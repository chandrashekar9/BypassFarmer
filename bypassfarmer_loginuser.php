...
mysqli_select_db($link,"bypassfarmer");
 ...
 if(isset($_SESSION['name'])){
	 ...
	 exit();
	   ...
	   $name=$_POST["name"];
    $pass=$_POST["pass"];
	$que="SELECT * FROM signinuser WHERE name='$name' && password='$pass'" ;
...
<form name="form" action="bypassfarmer_loginuser.php" method="post" id="id2" >
...
<td colspan="1" >
<button  onclick="location.href='newusersignin.html'" type="button" style="background-color:rgba(18, 14, 81, 0.6);" class="place" >SignUp</button>
</td></tr>
</table>
