...
$sql="INSERT INTO signinuser(name,password,email,mobile,address,city,state,zipcode,country) VALUES ('$a','$b','$c','$d','$e','$f','$g','$h','$i')";
...
?>
<html>
<button  style="background-color:rgba(18, 14, 81, 0.6);" class="place" type="button"  onclick="location.href='bypassfarmer_loginuser.php'">Go to login page</button>
</html>